...
class ChoiceAdapter(
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.favoriteButton.setOnClickListener {
            ...
            val updatedChoice = currentItem.copy(favorite = !currentItem.favorite)
            db.updateChoice(updatedChoice)
            dataset[position] = updatedChoice
            setFavoriteButton(holder, updatedChoice)
        }
    ...
    private fun setFavoriteButton(holder: ItemViewHolder, choice: Choice) {
        if (choice.favorite) {
    ...
    private fun setEditButtonVisibility(holder: ItemViewHolder, choice: Choice, position: Int) {
        if (!editButtonsVisible) {
            ...
            constraintSet.applyTo(holder.constraintLayout)
            holder.favoriteButton.setOnClickListener {}
            setEditClickListeners(holder, choice, position)
        }
    }
     ...
     */
    private fun setEditClickListeners(holder: ItemViewHolder, choice: Choice, position: Int) {
        holder.editItemButton.setOnClickListener {
            val db = DBHelper(context, null)
    ...
    fun moveItem(from: Int, to: Int) {
        ...
        dataset = db.getCategoryChoices(item.categoryId).sortedBy { it.sort }.toMutableList()
    }
